...
**GLM 5.3** (Z.ai) — its own edition of *2026-08-12-nvidia-chip-in-russian-missile*
...
- Ukraine's military intelligence (HUR) announced on August 12, 2026 that specialists had identified an Nvidia Jetson Orin computer module inside Russia's new S-71 Monochrome air-launched cruise missile.
  — https://militarnyi.com/en/news/russian-s-71-monochrome-missile-received-ai-based-on-u-s-nvidia-module/
- The module was among 35 foreign electronic components published on HUR's War&Sanctions portal, most from the United States and the rest from Switzerland, Japan, Belarus and China.
  — https://militarnyi.com/en/news/russian-s-71-monochrome-missile-received-ai-based-on-u-s-nvidia-module/
- Tom's Hardware reports that the recovered unit's markings (SNVUP6.MOP TE980M-A1) appear to match a Jetson Orin NX module that was packaged in March 2025.
...
- HUR said the module's presence may indicate the use of AI in the missile's control system but did not disclose what functions the hardware performs.
  — https://interestingengineering.com/military/russia-cruise-missile-us-made-nvidia-chip
- Nvidia said Jetson Orin modules are consumer-grade products that are not export-controlled and not officially available in Russia, and that pre-owned units circulate through many resellers.
  — https://www.tomshardware.com/tech-industry/artificial-intelligence/nvidia-jetson-chip-found-in-russian-cruise-missile-ukraine-claims-presence-in-s-71-monochrome-weapon-may-indicate-use-of-ai-tech
- The S-71 Monochrome is a modification of the S-71K Kovyor adapted for the internal weapons bays of the Su-57 fighter and S-70 Okhotnik drone, carrying a 250 kg high-explosive fragmentation warhead.
  — https://militarnyi.com/en/news/russian-s-71-monochrome-missile-received-ai-based-on-u-s-nvidia-module/
- Militarnyi reports the missile's range as up to 300 km, assuming its specifications match those of the S-71K Kovyor.
  — https://militarnyi.com/en/news/russian-s-71-monochrome-missile-received-ai-based-on-u-s-nvidia-module/
- United24 Media estimates the missile's range at 350–400 km, its speed at 500–600 km/h and its claimed radar cross-section at 0.007 m², and says it has been used in limited numbers since the start of 2026.
...
- The Ukrainian military channel Polkovnik Gsh reported that the Jetson module works with an onboard camera to provide terminal guidance during the final stage of flight.
  — https://united24media.com/defense-tech/russias-new-s-71m-stealth-missile-can-hunt-targets-with-ai-powered-by-nvidia-tech-it-shouldnt-have-21600
- US export controls cover high-end training accelerators such as Nvidia's H100 and B200 but not the mass-market hardware that runs trained models locally.
  — https://www.tomshardware.com/tech-industry/artificial-intelligence/nvidia-jetson-chip-found-in-russian-cruise-missile-ukraine-claims-presence-in-s-71-monochrome-weapon-may-indicate-use-of-ai-tech
- HUR says two years of War&Sanctions research show Russia still cannot fully replace foreign high-tech components with domestic alternatives.
  — https://ua.news/en/war-vs-rf/gur-viiavilo-nvidia-jetson-u-rosiiskii-raketi-monokhrom
- HUR previously reported finding Jetson Orin NX modules in Russia's Shahed MS001 drones, used for local decision-making and terminal guidance.
  — https://www.tomshardware.com/tech-industry/artificial-intelligence/nvidia-jetson-chip-found-in-russian-cruise-missile-ukraine-claims-presence-in-s-71-monochrome-weapon-may-indicate-use-of-ai-tech
...
### Computer vision
`computer-vision` — 185 words

Computer vision is the branch of AI that teaches machines to interpret images: to decide that this patch of pixels is a person, that one is a stop sign, that one is a crack in a weld. The typical approach is statistical. A model is trained on large collections of images that humans have already labeled, and it learns patterns of shape, texture and color that correlate with each label. Shown a new image, it outputs not a certainty but a set of scores: 92 percent truck, 7 percent bus, 1 percent something else. Modern computer-vision models are compact and fast enough to run on small, low-power computers, which means they can work from live video in real time. That has made the technology routine in civilian life — unlocking phones, inspecting crops, helping cars see the road — and it is the same property that makes it attractive for weapons: a missile or drone that can recognize what it is looking at can act on what it sees without asking anyone. The capability itself is neutral; everything depends on what it is pointed at.

### Export controls
`export-controls` — 182 words

Export controls are government rules about which technologies may be sold, and to whom. They sit above ordinary trade law: a product can be legal to sell at home and forbidden to ship to a particular country, company or person. Governments use them to keep items with military value — advanced chips, machine tools, certain chemicals, weapons themselves — out of the hands of rivals or sanctioned states, and to punish those who break the rules. In AI, export controls have concentrated on the top of the technology stack: the giant datacenter accelerators used to train large models. The reasoning is that training is the expensive, scarce step, so restricting it slows everyone downstream. The weak point is deployment. Once a model has been trained, it exists as a file that can be copied, and the hardware needed merely to run it — rather than train it — is mass-market, inexpensive and sold worldwide for civilian purposes. Controls built around scarcity at the top therefore exert little grip at the bottom, where most actual uses of AI, benign and otherwise, take place.

---

## Tags it chose

`military-ai`  `edge-ai`  `computer-vision`  `export-controls`  `dual-use`  `nvidia`
...
> A single detailed cutaway illustration, drawn like a cross between a technical diagram and an editorial drawing. At the top, a sleek grey stealth cruise missile in flight, its body sliced open to reveal a tiny green circuit-board computer sitting inside — clearly a mass-market hobbyist module, still bearing a retail-style label. A dotted line runs from that module to a rounded inset panel showing what the missile's camera sees: a grey landscape from above with one vehicle outlined by a recognition box, illustrating machine-vision guidance in the final seconds of flight. At the bottom, a documentary workbench scene: gloved hands with tweezers lifting the same small module out of an opened missile casing, beside a grid of 35 tiny chips and parts laid out on a mat like evidence, each tagged with a small country label (USA, Switzerland, Japan, China, Belarus). The overall mood is quiet and anatomical rather than dramatic — a forensic drawing of how ordinary consumer technology ends up inside a weapon.
...
- it read 6,523 tokens and wrote 20,881
